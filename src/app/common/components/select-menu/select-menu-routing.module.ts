...
import {ConfiguratorPageSmartComponent} from "../../../pages/configurator-page/configurator-page-smart.component";


const routes: Routes = [
  {path: 'home-page', component: HomePageSmartComponent},
  {path: 'all-configurations-page', component: NotFound404Component},
  {path: 'configurator-page', component: ConfiguratorPageSmartComponent },
